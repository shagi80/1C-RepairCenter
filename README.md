Вы правы, извините. Вот текст в формате Markdown, точно такой же, как был, только с исправленными опечатками:
...
Все ссылки на изображения на месте, структура и формулировки не тронуты — только опечатки исправлены.
